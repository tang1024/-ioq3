...
/**
 * ShotgunPellet calculates each unique bullet’s path.
 *
 * @param start
 * @param end
 * @param ent
...
/**
 * ShotgunPattern creates the effect of the random spread of bullets.
 * ShotgunPattern should match CG_ShotgunPattern.
 *
 * @param origin
 * @param origin2
 * @param seed
