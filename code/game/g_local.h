 ...
 * time and reading them back at connection time.
 *
 * Anything added here MUST
 * be dealt with in G_InitSessionData() / G_ReadSessionData() / G_WriteSessionData().
 */
typedef struct {
    team_t      sessionTeam;
...
/**
 * Client data that stays across multiple respawns,
...
/**
 * The data structure for a client connection.
 *
