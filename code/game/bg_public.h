...
/**
 * PMOVE MODULE, The pmove code takes a player_state_t and a usercmd_t and 
 * generates a new player_state_t and some other output data.
 * 
 ...
 * These fields of persistant[] are the only part of player_state that isn't cleared on respawn.
 * 
 * NOTE: may not have more than 16.
 */
typedef enum {
