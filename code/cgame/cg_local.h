...
/**
 * centity_t have a direct corespondence with gentity_t in the game,
 * but only the entityState_t is directly communicated to the cgame.
 */
...
/**
 * The client game static (cgs) structure hold everything loaded or calculated from the gamestate.
 * It will NOT be cleared when a tournament restart is done, allowing all clients to begin playing instantly.
 */
typedef struct {
