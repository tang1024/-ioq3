...
/**
 * Float a sprite over the player's head, determining the physical location of the vector above the player’s head and
 * assigning the proper shader.
 * 
 * @param cent The attacker.
 * @param shader The shader of the icon to hover above the player’s head.
 */
 ...
 *
 * @param ent Refers to the client-side version of the player entity.
 * @param state Refers to the currently communicated state (entityState_t) of the entity.
 * @param team
 */
