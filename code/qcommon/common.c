...
#ifdef ZONE_DEBUG
/**
 * Tag-based Zone memory allocation in debug mode.
 *
 * @param size
 * @param tag
 * @param label
...
#else
/**
 * Tag-based Zone memory allocation.
 *
 * @param size
 * @param tag
 * @return
...
#ifdef ZONE_DEBUG
/**
 * Zone memory allocation in debug mode.
 * 
 * @param size
 * @param label
 * @param file
...
/**
 * Init the zone memory "smallzone" by calling calloc().
 */
...
/**
 * Init the zone memory "mainzone" by calling calloc().
 */
...
/**
 * Init the hunk memory "s_hunkData" by calling calloc().
 */
