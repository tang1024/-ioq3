...
/**
 * ... and create a window ...
 * Call chain: GLimp_Init > GLimp_StartDriverAndSetMode > GLimp_SetMode.
 *
 * @param mode
 * @param fullscreen
 * @param noborder
...
/**
 * Called by GLimp_Init to create the window and set up the context.
 *
 * - Create a window by calling GLimp_SetMode.
 *
 * @param mode
 * @param fullscreen
 * @param noborder
